    ...
    <Body style={main}>
      <Container style={container}>
        <Img
          ...
          style={logo}
        />
        <Heading style={h1}>You're invited to the paddock</Heading>
        <Text style={text}>
          You've been invited to join{' '}
          <Link href={siteUrl} style={link}><strong>{siteName}</strong></Link>. Accept below to create your account and hit the grid.
        </Text>
